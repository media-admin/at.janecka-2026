...
class WC_GZDP_Multistep_Checkout {
	...
	public function set_body_class( $classes ) {
		if ( is_checkout() ) {
			...
			/**
			 * If Elementor is enabled - prevent Woo from overriding multistep checkout button styles
			 */
			if ( class_exists( '\Vendidero\Germanized\PluginsHelper' ) && \Vendidero\Germanized\PluginsHelper::is_plugin_active( 'elementor/elementor.php' ) ) {
	...
	public function print_steps() {
		...
		if ( apply_filters( 'woocommerce_gzdp_multistep_checkout_enable_custom_scroll', true ) ) {
			echo '<div id="woocommerce-multipstep-checkout-custom-scroll-marker"></div>';
		}
