		...
		public function initialize() {
			$default_steps = array(
				'activation' => array(
					...
					'order'   => 1,
					'errors'  => array(
						'helper_install' => sprintf( __( 'Sorry, we were not able to automatically install the Vendidero Helper Plugin. See <a href="%s" target="_blank">manual install instructions</a> for assitance.', 'woocommerce-germanized-pro' ), 'https://vendidero.de/doc/woocommerce-germanized/woocommerce-germanized-pro-installieren' ),
						'activation'     => sprintf( __( 'Sorry, Germanized could not be activated. Please see the <a href="%s" target="_blank">install instructions</a> for assistance.', 'woocommerce-germanized-pro' ), 'https://vendidero.de/doc/woocommerce-germanized/woocommerce-germanized-pro-installieren' ),
					),
				),
				'invoice'    => array(
