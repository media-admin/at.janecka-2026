	...
	protected function get_vat_id_settings() {
		return array(
			...
			array(
				...
				'custom_attributes' => array(
					'data-show_if_woocommerce_gzdp_enable_vat_check' => '',
					'data-show_if_woocommerce_gzdp_vat_requester_vat_id' => '',
				),
			),
			...
			array(
				'title'             => __( 'Alternate Shipping', 'woocommerce-germanized-pro' ),
				'desc'              => __( 'Allow VAT exemptions for different delivery addresses, even if no separate VAT ID has been specified.', 'woocommerce-germanized-pro' ) . '<div class="wc-gzd-additional-desc">' . __( 'By default, Germanized does not allow VAT exemption if there is an alternate shipping address but no VAT ID has been specified. In this way, Germanized ensures that the recipient of the goods is entitled to deduct VAT. This option ensures that VAT exemption is also possible if there is a different delivery address (delivery to the billing country) but no separate VAT ID has been specified. Please speak to your tax advisor before making any adjustments here.', 'woocommerce-germanized-pro' ) . '</div>',
				'id'                => 'woocommerce_gzdp_allow_vat_exempt_with_missing_shipping_vat_id',
				'default'           => 'no',
				'type'              => 'gzd_toggle',
				'custom_attributes' => array(
					'data-show_if_woocommerce_gzdp_enable_vat_check' => '',
