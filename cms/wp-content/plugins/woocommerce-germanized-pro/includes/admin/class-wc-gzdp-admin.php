						...
						<fieldset>
							<label for="<?php echo esc_attr( $value['id'] . '_' . $key ); ?>">
								<input
									...
									<?php checked( ( ( in_array( $key, $option_values ) || $value['default'] == $key ) ? true : false ), true ); // phpcs:ignore WordPress.PHP.StrictInArray.MissingTrueStrict, Universal.Operators.StrictComparisons.LooseEqual ?>
									<?php echo implode( ' ', $custom_attributes ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
