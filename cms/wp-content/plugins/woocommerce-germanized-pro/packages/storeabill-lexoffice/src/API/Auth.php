...
class Auth extends REST implements OAuth {
	...
	public function get_description() {
		return _x( 'Click on the button and login to lexware to authorize Germanized. After that you will be redirected to a page showing an authorization code. Please copy & paste that code into the field below.', 'lexoffice', 'woocommerce-germanized-pro' );
	}
