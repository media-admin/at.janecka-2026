...
class Package {
	...
	public static function get_auth_url() {
		return defined( 'SAB_LEXOFFICE_AUTH_URL' ) ? SAB_LEXOFFICE_AUTH_URL : 'https://app.lexware.de/oauth2/';
	}

	public static function get_api_url() {
		return defined( 'SAB_LEXOFFICE_API_URL' ) ? SAB_LEXOFFICE_API_URL : 'https://api.lexware.io/v1/';
	}

	public static function get_app_url() {
		return defined( 'SAB_LEXOFFICE_APP_URL' ) ? SAB_LEXOFFICE_APP_URL : 'https://app.lexware.de/';
	}
