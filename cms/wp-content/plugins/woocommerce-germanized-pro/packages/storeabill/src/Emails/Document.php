...
class Document extends Email {
	...
	protected function is_valid( $document ) {
		return is_a( $document, 'Vendidero\StoreaBill\Document\Document' ) && $document->has_primary_file();
	}
	...
	public function get_attachments() {
		...
		if ( $this->is_valid( $this->object ) ) {
			$attachments[] = $this->object->get_primary_path( 'email_attachment' );
		}
