						...
						if ( $order->needs_payment() ) {
							add_action(
								...
								function ( $context, $payment_result ) {
									...
									sab_remove_all_hooks( 'woocommerce_rest_checkout_process_payment_with_context', 1003 );
								},
								1003,
								2
							);
							...
							add_filter(
								...
								function ( $redirect, $order ) {
									...
									sab_remove_all_hooks( 'woocommerce_get_checkout_order_received_url', 1003 );
	...
	public static function sync_invoices( $order, $args = array() ) {
		...
		if ( $defer ) {
			...
			$queue->schedule_single(
				apply_filters( 'storeabill_woo_defer_auto_order_invoice_creation_time', time() + 50, $order_id, $order ),
