...
class Settings {
	...
	public static function render_document_fields( $settings, $document, $echo = false ) {
		...
		foreach ( $settings as $setting ) {
			...
			$setting['wrapper_class'] .= "form-field-{$setting['type']}";

			if ( has_action( "storeabill_admin_document_field_{$setting['id']}" ) ) {
				do_action( "storeabill_admin_document_field_{$setting['id']}", $setting, $document );
				...
				do_action( "storeabill_admin_document_field_{$setting['type']}", $setting, $document );
			}
		}
