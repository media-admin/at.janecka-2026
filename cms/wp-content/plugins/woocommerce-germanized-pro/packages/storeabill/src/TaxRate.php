...
class TaxRate {
	...
	/**
	 * Returns the formatted tax rate without percentage sign.
	 *
	 * @return string
	 */
	public function get_formatted_percent() {
		return sab_format_tax_rate_percentage( $this->get_percent(), array( 'percentage_sign' => '' ) );
	}

	/**
	 * Returns the formatted tax rate with percentage sign.
	 *
	 * @return string
	 */
