...
class UploadManager {
	...
	public static function set_upload_mimes_filter() {
		add_filter( 'upload_mimes', array( __CLASS__, 'filter_upload_mimes' ), PHP_INT_MAX, 1 );
	}

	public static function unset_upload_mimes_filter() {
		remove_filter( 'upload_mimes', array( __CLASS__, 'filter_upload_mimes' ), PHP_INT_MAX );
	}
