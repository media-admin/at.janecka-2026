				...
				<div class="wp-block-columns">
					...
					<div class="wp-block-column" style="flex-basis:66.66%">
						...
						<?php else : ?>
							...
							<p class="has-text-color" style="font-size:30px;color:<?php echo esc_attr( self::get_light_color() ); ?>"><strong><?php echo wp_kses_post( BusinessInformation::get_base_company_name() ); ?></strong></p>
							<!-- /wp:paragraph -->
						<?php endif; ?>
					</div>
					<!-- /wp:column -->
					...
					<div class="wp-block-column" style="flex-basis:33.33%">
						...
						<p class="has-text-align-right has-text-color has-small-font-size" style="color:<?php echo esc_attr( self::get_light_color() ); ?>">
							<span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'Base address', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="business_information?data=base_address_data&format=address"><span class="editor-placeholder"></span><?php echo wp_kses_post( BusinessInformation::get_formatted_base_address() ); ?></span><br>
							<?php do_action( self::get_hook_prefix() . 'after_company_address_header' ); ?><br>
						</p>
						<!-- /wp:paragraph -->
						<!-- wp:paragraph {"align":"right","fontSize":"small","style":{"color":{"text":"<?php echo esc_attr( self::get_light_color() ); ?>"}}} -->
						<p class="has-text-align-right has-text-color has-small-font-size" style="color:<?php echo esc_attr( self::get_light_color() ); ?>">
							<?php printf( esc_html_x( 'E-Mail:', 'storeabill-core', 'woocommerce-germanized-pro' ) ); ?> <span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'E-Mail', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="business_information?data=contact_email"><span class="editor-placeholder"></span><?php echo esc_html( BusinessInformation::get_contact_email() ); ?></span><br>
							<?php if ( ! empty( BusinessInformation::get_contact_phone() ) ) : ?>
								<?php printf( esc_html_x( 'Phone:', 'storeabill-core', 'woocommerce-germanized-pro' ) ); ?> <span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'Phone', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="business_information?data=contact_phone"><span class="editor-placeholder"></span><?php echo esc_html( BusinessInformation::get_contact_phone() ); ?></span><br>
							<?php endif; ?>
				...
				<div class="wp-block-columns">
					...
					<div class="wp-block-column" style="flex-basis:42.4%">
						...
						<p class="has-text-color has-small-font-size" style="color:<?php echo esc_attr( self::get_light_color() ); ?>">
							<?php printf( esc_html_x( 'Holder:', 'storeabill-bank-account', 'woocommerce-germanized-pro' ) ); ?> <span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'Bank account holder', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="business_information?data=holder"><span class="editor-placeholder"></span><?php echo esc_html( sab_get_base_bank_account_data( 'holder' ) ); ?></span><br>
							<?php printf( esc_html_x( 'IBAN:', 'storeabill-bank-account', 'woocommerce-germanized-pro' ) ); ?> <span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'IBAN', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="business_information?data=iban"><span class="editor-placeholder"></span><?php echo esc_html( sab_get_base_bank_account_data( 'iban' ) ); ?></span><br>
							<?php printf( esc_html_x( 'BIC:', 'storeabill-bank-account', 'woocommerce-germanized-pro' ) ); ?> <span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'BIC', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="business_information?data=bic"><span class="editor-placeholder"></span><?php echo esc_html( sab_get_base_bank_account_data( 'bic' ) ); ?></span><br>
						</p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:column -->
					...
					<div class="wp-block-column">
						<!-- wp:paragraph {"align":"right","fontSize":"small","style":{"color":{"text":"<?php echo esc_attr( self::get_light_color() ); ?>"}}} -->
						<p class="has-text-align-right has-text-color has-small-font-size" style="color:<?php echo esc_attr( self::get_light_color() ); ?>"><strong><?php echo wp_kses_post( BusinessInformation::get_base_company_name() ); ?></strong></p>
						<!-- /wp:paragraph -->

						<!-- wp:paragraph {"align":"right","fontSize":"small","style":{"color":{"text":"<?php echo esc_attr( self::get_light_color() ); ?>"}}} -->
						<p class="has-text-align-right has-text-color has-small-font-size" style="color:<?php echo esc_attr( self::get_light_color() ); ?>">
							<span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'Base address', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="business_information?data=base_address_data&format=address:break:no"><span class="editor-placeholder"></span><?php echo wp_kses_post( BusinessInformation::get_formatted_base_address( '<br/>', true ) ); ?></span><br>

							<?php if ( ! empty( BusinessInformation::get_vat_id() ) ) : ?>
								<?php printf( esc_html_x( 'VAT ID:', 'storeabill-core', 'woocommerce-germanized-pro' ) ); ?> <span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'VAT ID', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="business_information?data=vat_id"><span class="editor-placeholder"></span><?php echo esc_html( BusinessInformation::get_vat_id() ); ?></span><br>
							<?php elseif ( ! empty( BusinessInformation::get_local_tax_number() ) ) : ?>
								<?php printf( esc_html_x( 'Tax number:', 'storeabill-core', 'woocommerce-germanized-pro' ) ); ?> <span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'Tax number', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="business_information?data=local_tax_number"><span class="editor-placeholder"></span><?php echo esc_html( BusinessInformation::get_local_tax_number() ); ?></span><br>
							<?php endif; ?>
							<?php if ( ! empty( BusinessInformation::get_company_registration_number() ) ) : ?>
								<?php printf( esc_html_x( 'Register:', 'storeabill-core', 'woocommerce-germanized-pro' ) ); ?> <span class="document-shortcode sab-tooltip" contenteditable="false" data-tooltip="<?php echo esc_attr_x( 'Company registration number', 'storeabill-core', 'woocommerce-germanized-pro' ); ?>" data-shortcode="business_information?data=company_registration_number"><span class="editor-placeholder"></span><?php echo esc_html( BusinessInformation::get_company_registration_number() ); ?></span><br>
							<?php endif; ?>
