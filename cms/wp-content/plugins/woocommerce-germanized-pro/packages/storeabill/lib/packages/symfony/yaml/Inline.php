...
namespace Vendidero\StoreaBill\Vendor\Symfony\Component\Yaml;

use Vendidero\StoreaBill\Vendor\Symfony\Component\Yaml\Exception\DumpException;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Yaml\Exception\ParseException;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Yaml\Tag\TaggedValue;
                ...
                switch (true) {
                    ...
                    case 0 === strpos($scalar, '!php/object'):
                        if (self::$objectSupport) {
                            if (!isset($scalar[12])) {
                                storeabill_vendor_trigger_deprecation('symfony/yaml', '5.1', 'Using the !php/object tag without a value is deprecated.');
                    ...
                    case 0 === strpos($scalar, '!php/const'):
                        if (self::$constantSupport) {
                            if (!isset($scalar[11])) {
                                storeabill_vendor_trigger_deprecation('symfony/yaml', '5.1', 'Using the !php/const tag without a value is deprecated.');
                ...
                switch (true) {
                    case ctype_digit($scalar):
                        if (preg_match('/^0[0-7]+$/', $scalar)) {
                            storeabill_vendor_trigger_deprecation('symfony/yaml', '5.1', 'Support for parsing numbers prefixed with 0 as octal numbers. They will be parsed as strings as of 6.0. Use "%s" to represent the octal number.', '0o'.substr($scalar, 1));
                    ...
                    case '-' === $scalar[0] && ctype_digit(substr($scalar, 1)):
                        if (preg_match('/^-0[0-7]+$/', $scalar)) {
                            storeabill_vendor_trigger_deprecation('symfony/yaml', '5.1', 'Support for parsing numbers prefixed with 0 as octal numbers. They will be parsed as strings as of 6.0. Use "%s" to represent the octal number.', '-0o'.substr($scalar, 2));
