...
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Encoding\EncodingLocator;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Encoding\PostScriptGlyphs;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Exception\EncodingNotFoundException;
...
class Encoding extends PDFObject
{
    ...
    protected function getEncodingClass(): string
    {
        ...
        $className = '\\Vendidero\\StoreaBill\\Vendor\\Smalot\\PdfParser\\Encoding\\'.$baseEncoding;
