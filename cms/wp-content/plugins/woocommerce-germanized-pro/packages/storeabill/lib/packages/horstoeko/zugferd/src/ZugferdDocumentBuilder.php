...
use DOMXPath;
use DOMDocument;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\codelists\ZugferdDocumentType;
...
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\codelists\ZugferdReferenceCodeQualifiers;
