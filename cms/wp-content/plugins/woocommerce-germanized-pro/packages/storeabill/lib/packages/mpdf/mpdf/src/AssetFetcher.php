...
use Vendidero\StoreaBill\Vendor\Mpdf\PsrHttpMessageShim\Request;
use Vendidero\StoreaBill\Vendor\Mpdf\PsrLogAwareTrait\PsrLogAwareTrait;
...
class AssetFetcher implements \Vendidero\StoreaBill\Vendor\Psr\Log\LoggerAwareInterface
{
	...
	public function fetchRemoteContent($path)
	{
		...
		try {
			...
			/** @var \Vendidero\StoreaBill\Vendor\Mpdf\PsrHttpMessageShim\Response $response */
