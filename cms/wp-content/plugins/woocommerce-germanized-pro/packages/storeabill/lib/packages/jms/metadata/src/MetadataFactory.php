...
use Vendidero\StoreaBill\Vendor\Metadata\Driver\AdvancedDriverInterface;
...
class MetadataFactory implements AdvancedMetadataFactoryInterface
{
    ...
    public function __construct(DriverInterface $driver, ?string $hierarchyMetadataClass = 'Vendidero\StoreaBill\Vendor\Metadata\ClassHierarchyMetadata', bool $debug = false)
    {
        $this->driver = $driver;
