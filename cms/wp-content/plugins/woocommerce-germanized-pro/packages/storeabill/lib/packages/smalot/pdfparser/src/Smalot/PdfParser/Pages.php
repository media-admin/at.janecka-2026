...
{
    /**
     * @var array<\Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Font>|null
     */
    protected $fonts;
    /**
    ...
    protected function setupFonts()
    {
        ...
        if (method_exists($resources, 'has') && $resources->has('Font')) {
            ...
            if ($resources->get('Font') instanceof \Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Element\ElementMissing) {
                return;
            }
