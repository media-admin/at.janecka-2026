...
class ReferencedDocumentType
{
    ...
    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\IDType $issuerAssignedID
     */
    ...
    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\BinaryObjectType $attachmentBinaryObject
     */
    ...
    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\qdt\FormattedDateTimeType $formattedIssueDateTime
     */
     ...
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\IDType $issuerAssignedID
     * @return self
     */
    public function setIssuerAssignedID(?\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\IDType $issuerAssignedID = null)
    {
     ...
     * @return self
     */
    public function setLineID(?\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\IDType $lineID = null)
    {
        $this->lineID = $lineID;
        return $this;
    }
     ...
     *
     * @return \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\BinaryObjectType
     */
     ...
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\BinaryObjectType $attachmentBinaryObject
     * @return self
     */
    public function setAttachmentBinaryObject(?\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\BinaryObjectType $attachmentBinaryObject = null)
    {
     ...
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\qdt\FormattedDateTimeType $formattedIssueDateTime
     * @return self
     */
    public function setFormattedIssueDateTime(?\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\qdt\FormattedDateTimeType $formattedIssueDateTime = null)
    {
