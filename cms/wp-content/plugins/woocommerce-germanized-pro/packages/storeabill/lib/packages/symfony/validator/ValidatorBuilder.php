 ...
 */
namespace Vendidero\StoreaBill\Vendor\Symfony\Component\Validator;
...
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Context\ExecutionContextFactory;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Exception\LogicException;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Exception\ValidatorException;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\Factory\LazyLoadingMetadataFactory;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\Factory\MetadataFactoryInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\Loader\AnnotationLoader;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\Loader\LoaderChain;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\Loader\LoaderInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\Loader\XmlFileLoader;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\Loader\YamlFileLoader;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Validator\RecursiveValidator;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Validator\ValidatorInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Contracts\Translation\LocaleAwareInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Contracts\Translation\TranslatorInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Contracts\Translation\TranslatorTrait;
...
class ValidatorBuilder
{
    ...
    public function enableAnnotationMapping()
    {
        ...
        if (false === $skipDoctrineAnnotations || null === $skipDoctrineAnnotations) {
            storeabill_vendor_trigger_deprecation('symfony/validator', '5.2', 'Not passing true as first argument to "%s" is deprecated. Pass true and call "addDefaultDoctrineAnnotationReader()" if you want to enable annotation mapping with Doctrine Annotations.', __METHOD__);
            $this->addDefaultDoctrineAnnotationReader();
        } elseif ($skipDoctrineAnnotations instanceof Reader) {
            storeabill_vendor_trigger_deprecation('symfony/validator', '5.2', 'Passing an instance of "%s" as first argument to "%s" is deprecated. Pass true instead and call setDoctrineAnnotationReader() if you want to enable annotation mapping with Doctrine Annotations.', get_debug_type($skipDoctrineAnnotations), __METHOD__);
    ...
    private function createAnnotationReader(): Reader
    {
        ...
        if (class_exists(CachedReader::class) && class_exists(ArrayCache::class)) {
            storeabill_vendor_trigger_deprecation('symfony/validator', '5.4', 'Enabling annotation based constraint mapping without having symfony/cache installed is deprecated.');
