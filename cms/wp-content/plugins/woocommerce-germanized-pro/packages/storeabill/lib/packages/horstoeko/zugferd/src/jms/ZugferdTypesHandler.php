...
namespace Vendidero\StoreaBill\Vendor\horstoeko\zugferd\jms;

use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\ZugferdSettings;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\GraphNavigator;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Handler\SubscribingHandlerInterface;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\XmlSerializationVisitor;
    ...
    public static function getSubscribingMethods()
    {
        return [
            [
                ...
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\minimum\udt\AmountType',
                'method' => 'serializeAmountType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\AmountType',
                'method' => 'serializeAmountType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basicwl\udt\AmountType',
                'method' => 'serializeAmountType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\en16931\udt\AmountType',
                'method' => 'serializeAmountType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType',
                'method' => 'serializeAmountType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\QuantityType',
                'method' => 'serializeQuantityType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basicwl\udt\QuantityType',
                'method' => 'serializeQuantityType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\en16931\udt\QuantityType',
                'method' => 'serializeQuantityType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\QuantityType',
                'method' => 'serializeQuantityType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\PercentType',
                'method' => 'serializePercentType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basicwl\udt\PercentType',
                'method' => 'serializePercentType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\en16931\udt\PercentType',
                'method' => 'serializePercentType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\PercentType',
                'method' => 'serializePercentType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\IndicatorType',
                'method' => 'serializeIndicatorType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basicwl\udt\IndicatorType',
                'method' => 'serializeIndicatorType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\en16931\udt\IndicatorType',
                'method' => 'serializeIndicatorType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\IndicatorType',
                'method' => 'serializeIndicatorType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\MeasureType',
                'method' => 'serializeMeasureType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basicwl\udt\MeasureType',
                'method' => 'serializeMeasureType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\en16931\udt\MeasureType',
                'method' => 'serializeMeasureType'
            ],
            [
                'direction' => GraphNavigator::DIRECTION_SERIALIZATION,
                'format' => 'xml',
                'type' => 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\MeasureType',
                'method' => 'serializeMeasureType'
            ],
        ];
    }
