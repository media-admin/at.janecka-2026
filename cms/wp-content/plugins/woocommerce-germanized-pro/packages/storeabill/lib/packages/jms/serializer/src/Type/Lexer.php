...
namespace Vendidero\StoreaBill\Vendor\JMS\Serializer\Type;

use Vendidero\StoreaBill\Vendor\Doctrine\Common\Lexer\AbstractLexer;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Type\Exception\SyntaxError;
