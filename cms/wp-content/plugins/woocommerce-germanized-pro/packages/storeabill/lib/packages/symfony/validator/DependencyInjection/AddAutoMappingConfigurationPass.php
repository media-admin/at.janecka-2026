...
namespace Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\DependencyInjection;
...
class AddAutoMappingConfigurationPass implements CompilerPassInterface
{
    ...
    {
        if (0 < \func_num_args()) {
            storeabill_vendor_trigger_deprecation('symfony/validator', '5.3', 'Configuring "%s" is deprecated.', __CLASS__);
        }
