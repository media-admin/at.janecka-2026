...
namespace Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\Factory;
...
class LazyLoadingMetadataFactory implements MetadataFactoryInterface
{
    ...
    private function mergeConstraints(ClassMetadata $metadata)
    {
        ...
        foreach ($metadata->getReflectionClass()->getInterfaces() as $interface) {
            if ('Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\GroupSequenceProviderInterface' === $interface->name) {
                continue;
            }
