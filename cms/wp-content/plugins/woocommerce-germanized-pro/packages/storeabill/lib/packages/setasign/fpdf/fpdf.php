...
function __construct($orientation='P', $unit='mm', $size='A4')
{
	...
	// Metadata
	$this->metadata = array('Producer'=>'StoreaBill_Vendor_FPDF '.self::VERSION);
...
{
	// Fatal error
	throw new Exception('StoreaBill_Vendor_FPDF error: '.$msg);
}
