...
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraints\DisableAutoMapping;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraints\EnableAutoMapping;
...
class GenericMetadata implements MetadataInterface
{
    ...
    public function addConstraint(Constraint $constraint)
    {
        if ($constraint instanceof Traverse || $constraint instanceof Cascade) {
            throw new ConstraintDefinitionException(sprintf('The constraint "%s" can only be put on classes. Please use "Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraints\Valid" instead.', get_debug_type($constraint)));
        }
