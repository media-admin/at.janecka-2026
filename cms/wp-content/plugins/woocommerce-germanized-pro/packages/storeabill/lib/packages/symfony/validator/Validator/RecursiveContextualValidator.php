...
namespace Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Validator;

use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraint;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraints\Composite;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraints\Existence;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraints\GroupSequence;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraints\Valid;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\ConstraintValidatorFactoryInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Context\ExecutionContext;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Context\ExecutionContextInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Exception\ConstraintDefinitionException;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Exception\NoSuchMetadataException;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Exception\RuntimeException;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Exception\UnexpectedValueException;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Exception\UnsupportedMetadataException;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Exception\ValidatorException;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\CascadingStrategy;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\ClassMetadataInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\Factory\MetadataFactoryInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\GenericMetadata;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\GetterMetadata;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\MetadataInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\PropertyMetadataInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\TraversalStrategy;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\ObjectInitializerInterface;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Util\PropertyPath;
...
class RecursiveContextualValidator implements ContextualValidatorInterface
{
    ...
    public function validateProperty(object $object, string $propertyName, $groups = null)
    {
        ...
        if (!$classMetadata instanceof ClassMetadataInterface) {
            throw new ValidatorException(sprintf('The metadata factory should return instances of "\Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\ClassMetadataInterface", got: "%s".', get_debug_type($classMetadata)));
        }
    ...
    private function validateObject(object $object, string $propertyPath, array $groups, int $traversalStrategy, ExecutionContextInterface $context)
    {
        try {
            ...
            if (!$classMetadata instanceof ClassMetadataInterface) {
                throw new UnsupportedMetadataException(sprintf('The metadata factory should return instances of "Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\ClassMetadataInterface", got: "%s".', get_debug_type($classMetadata)));
            }
        ...
        foreach ($groups as $key => $group) {
            ...
            if (Constraint::DEFAULT_GROUP === $group) {
                if ($metadata->hasGroupSequence()) {
                    ...
                    // object
                    /* @var \Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\GroupSequenceProviderInterface $object */
        ...
        foreach ($metadata->getConstrainedProperties() as $propertyName) {
            ...
            foreach ($metadata->getPropertyMetadata($propertyName) as $propertyMetadata) {
                if (!$propertyMetadata instanceof PropertyMetadataInterface) {
                    throw new UnsupportedMetadataException(sprintf('The property metadata instances should implement "Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping\PropertyMetadataInterface", got: "%s".', get_debug_type($propertyMetadata)));
                }
