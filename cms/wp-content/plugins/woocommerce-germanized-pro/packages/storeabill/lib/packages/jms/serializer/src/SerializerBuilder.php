...
namespace Vendidero\StoreaBill\Vendor\JMS\Serializer;
...
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Builder\DefaultDriverFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Builder\DocBlockDriverFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Builder\DriverFactoryInterface;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Construction\ObjectConstructorInterface;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Construction\UnserializeObjectConstructor;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\ContextFactory\CallableDeserializationContextFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\ContextFactory\CallableSerializationContextFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\ContextFactory\DeserializationContextFactoryInterface;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\ContextFactory\SerializationContextFactoryInterface;
...
use Vendidero\StoreaBill\Vendor\JMS\Serializer\EventDispatcher\Subscriber\DoctrineProxySubscriber;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\EventDispatcher\Subscriber\EnumSubscriber;
...
use Vendidero\StoreaBill\Vendor\JMS\Serializer\GraphNavigator\Factory\DeserializationGraphNavigatorFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\GraphNavigator\Factory\GraphNavigatorFactoryInterface;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\GraphNavigator\Factory\SerializationGraphNavigatorFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Handler\ArrayCollectionHandler;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Handler\DateHandler;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Handler\EnumHandler;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Handler\HandlerRegistry;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Handler\HandlerRegistryInterface;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Handler\IteratorHandler;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Handler\StdClassHandler;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Handler\UnionHandler;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Naming\CamelCaseNamingStrategy;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Naming\PropertyNamingStrategyInterface;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Naming\SerializedNameAnnotationStrategy;
...
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Visitor\Factory\DeserializationVisitorFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Visitor\Factory\JsonDeserializationVisitorFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Visitor\Factory\JsonSerializationVisitorFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Visitor\Factory\SerializationVisitorFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Visitor\Factory\XmlDeserializationVisitorFactory;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Visitor\Factory\XmlSerializationVisitorFactory;
use Vendidero\StoreaBill\Vendor\Metadata\Cache\CacheInterface;
use Vendidero\StoreaBill\Vendor\Metadata\Cache\FileCache;
use Vendidero\StoreaBill\Vendor\Metadata\MetadataFactory;
