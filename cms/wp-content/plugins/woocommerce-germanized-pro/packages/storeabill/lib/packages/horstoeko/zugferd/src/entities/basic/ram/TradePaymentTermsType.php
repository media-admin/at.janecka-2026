...
class TradePaymentTermsType
{
    ...
    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\DateTimeType $dueDateDateTime
     */
    private $dueDateDateTime = null;

    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\IDType $directDebitMandateID
     */
     ...
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\DateTimeType $dueDateDateTime
     * @return self
     */
    public function setDueDateDateTime(?\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\DateTimeType $dueDateDateTime = null)
    {
     ...
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\IDType $directDebitMandateID
     * @return self
     */
    public function setDirectDebitMandateID(?\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\IDType $directDebitMandateID = null)
    {
