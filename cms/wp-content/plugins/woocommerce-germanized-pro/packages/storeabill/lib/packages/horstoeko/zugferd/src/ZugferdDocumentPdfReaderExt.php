...
use Exception;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\exception\ZugferdFileNotFoundException;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\exception\ZugferdFileNotReadableException;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\exception\ZugferdNoPdfAttachmentFoundException;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\exception\ZugferdUnknownProfileException;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\exception\ZugferdUnknownProfileParameterException;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\exception\ZugferdUnknownXmlContentException;
use Vendidero\StoreaBill\Vendor\JMS\Serializer\Exception\RuntimeException;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Parser as PdfParser;
...
class ZugferdDocumentPdfReaderExt
{
     ...
     * @see    \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\ZugferdDocumentPdfReader::readAndGuessFromFile() For a similar purpose in another context.
     */
     ...
     * @throws ZugferdUnknownProfileException
     * @throws ZugferdUnknownProfileParameterException
     * @see    \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\ZugferdDocumentPdfReader::readAndGuessFromContent() For a similar purpose in another context.
     */
     ...
     * @throws Exception
     * @throws ZugferdNoPdfAttachmentFoundException
     * @see    \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\ZugferdDocumentPdfReader::getXmlFromFile() For a similar purpose in another context.
     */
     ...
     * @throws Exception
     * @throws ZugferdNoPdfAttachmentFoundException
     * @see    \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\ZugferdDocumentPdfReader::getXmlFromContent() For a similar purpose in another context.
     */
