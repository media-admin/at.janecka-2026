...
use DOMXpath;
use Throwable;
use Vendidero\StoreaBill\Vendor\horstoeko\mimedb\MimeDb;
use Vendidero\StoreaBill\Vendor\horstoeko\stringmanagement\FileUtils;
use Vendidero\StoreaBill\Vendor\horstoeko\stringmanagement\StringUtils;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\codelists\ZugferdInvoiceType;
...
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\exception\ZugferdUnknownMimetype;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\exception\ZugferdInvalidArgumentException;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\ZugferdPackageVersion;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\ZugferdPdfWriter;
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\ZugferdSettings;
use Vendidero\StoreaBill\Vendor\setasign\Fpdi\PdfParser\StreamReader as PdfStreamReader;
...
abstract class ZugferdDocumentPdfBuilderAbstract
{
    ...
    private function startCreatePdf(): void
    {
        ...
        for ($pageNumber = 1; $pageNumber <= $pageCount; ++$pageNumber) {
            $pageContent = $this->pdfWriter->importPage($pageNumber, '/MediaBox', false, true);
