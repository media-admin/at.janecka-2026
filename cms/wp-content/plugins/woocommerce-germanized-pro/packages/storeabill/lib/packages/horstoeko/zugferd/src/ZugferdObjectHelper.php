...
use Vendidero\StoreaBill\Vendor\horstoeko\zugferd\exception\ZugferdUnsupportedMimetype;
...
class ZugferdObjectHelper
{
    ...
    {
        $className = 'Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\\' . $this->profiledef["name"] . '\\' . $classname;
