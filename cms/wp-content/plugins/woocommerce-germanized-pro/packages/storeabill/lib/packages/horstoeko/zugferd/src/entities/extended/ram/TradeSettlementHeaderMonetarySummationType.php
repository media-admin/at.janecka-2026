...
class TradeSettlementHeaderMonetarySummationType
{
    ...
    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $taxBasisTotalAmount
     */
    ...
    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $roundingAmount
     */
    ...
    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $totalPrepaidAmount
     */
    private $totalPrepaidAmount = null;

    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $duePayableAmount
     */
     ...
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $taxBasisTotalAmount
     * @return self
     */
    public function setTaxBasisTotalAmount(\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $taxBasisTotalAmount)
    {
     ...
     */
    public function addToTaxTotalAmount(\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $taxTotalAmount)
    {
     ...
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $roundingAmount
     * @return self
     */
    public function setRoundingAmount(?\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $roundingAmount = null)
    {
     ...
     * @return self
     */
    public function setGrandTotalAmount(\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $grandTotalAmount)
    {
     ...
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $totalPrepaidAmount
     * @return self
     */
    public function setTotalPrepaidAmount(?\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $totalPrepaidAmount = null)
    {
     ...
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $duePayableAmount
     * @return self
     */
    public function setDuePayableAmount(\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\extended\udt\AmountType $duePayableAmount)
    {
