...
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Exception\MissingOptionsException;
    ...
    public function __construct(
        ...
        if (null !== $this->min && null !== $this->max) {
            ...
            if ($this->deprecatedMinMessageSet || $this->deprecatedMaxMessageSet) {
                storeabill_vendor_trigger_deprecation('symfony/validator', '4.4', '"minMessage" and "maxMessage" are deprecated when the "min" and "max" options are both set. Use "notInRangeMessage" instead.');
            }
        }
    }
}
