...
namespace Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Mapping;

use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraint;
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraints\Cascade;
...
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Constraints\Traverse;
...
use Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\Exception\GroupDefinitionException;
...
class ClassMetadata extends GenericMetadata implements ClassMetadataInterface
{
    ...
    public function setGroupSequenceProvider(bool $active)
    {
        ...
        if (!$this->getReflectionClass()->implementsInterface('Vendidero\StoreaBill\Vendor\Symfony\Component\Validator\GroupSequenceProviderInterface')) {
