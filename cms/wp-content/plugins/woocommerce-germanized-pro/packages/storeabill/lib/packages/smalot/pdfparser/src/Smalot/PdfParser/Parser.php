...
namespace Vendidero\StoreaBill\Vendor\Smalot\PdfParser;

use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Element\ElementArray;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Element\ElementBoolean;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Element\ElementDate;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Element\ElementHexa;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Element\ElementName;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Element\ElementNull;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Element\ElementNumeric;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Element\ElementString;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Element\ElementXRef;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\RawData\RawDataParser;
            ...
            switch ($part[0]) {
                ...
                case 'stream':
                    ...
                    if ($header->get('Type')->equals('ObjStm')) {
                        ...
                        return;
                    } elseif ($header->get('Type')->equals('Vendidero\StoreaBill\Vendor\Metadata')) {
