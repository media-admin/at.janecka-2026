...
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Exception\InvalidDictionaryObjectException;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\XObject\Form;
use Vendidero\StoreaBill\Vendor\Smalot\PdfParser\XObject\Image;
    ...
    public static function factory(
        ...
        switch ($header->get('Type')->getContent()) {
            ...
            case 'Font':
                ...
                $classname = '\Vendidero\StoreaBill\Vendor\Smalot\PdfParser\Font\Font'.$subtype;
