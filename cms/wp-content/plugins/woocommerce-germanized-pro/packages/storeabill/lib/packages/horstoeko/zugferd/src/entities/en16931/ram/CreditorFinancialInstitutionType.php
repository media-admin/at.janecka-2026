...
class CreditorFinancialInstitutionType
{
    ...
    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\en16931\udt\IDType $bICID
     */
    private $bICID = null;
     ...
     * Sets a new bICID
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\en16931\udt\IDType $bICID
     * @return self
     */
    public function setBICID(\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\en16931\udt\IDType $bICID)
    {
        $this->bICID = $bICID;
        return $this;
    }
