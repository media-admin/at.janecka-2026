...
class UniversalCommunicationType
{
    ...
    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\IDType $uRIID
     */
    private $uRIID = null;
     ...
     * Sets a new uRIID
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\IDType $uRIID
     * @return self
     */
    public function setURIID(\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\IDType $uRIID)
    {
        $this->uRIID = $uRIID;
        return $this;
    }
