...
class ExchangedDocumentType
{
    ...
    /**
     * @var \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\DateTimeType $issueDateTime
     */
     ...
     * @return self
     */
    public function setID(\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\IDType $iD)
    {
        $this->iD = $iD;
        return $this;
    }
     ...
     *
     * @param  \Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\DateTimeType $issueDateTime
     * @return self
     */
    public function setIssueDateTime(\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\udt\DateTimeType $issueDateTime)
    {
     ...
     */
    public function addToIncludedNote(\Vendidero\StoreaBill\Vendor\horstoeko\zugferd\entities\basic\ram\NoteType $includedNote)
    {
