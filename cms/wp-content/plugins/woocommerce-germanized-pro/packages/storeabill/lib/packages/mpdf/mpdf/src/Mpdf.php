...
use Vendidero\StoreaBill\Vendor\Mpdf\PsrLogAwareTrait\MpdfPsrLogAwareTrait;
...
class Mpdf implements \Vendidero\StoreaBill\Vendor\Psr\Log\LoggerAwareInterface
{
	...
	public function __construct(array $config = [], $container = null)
	{
		...
		assert(!$container || $container instanceof \Vendidero\StoreaBill\Vendor\Mpdf\Container\ContainerInterface);
	...
	{
		if ($txt instanceof \Vendidero\StoreaBill\Vendor\Mpdf\WatermarkText) {
	...
	{
		if ($src instanceof \Vendidero\StoreaBill\Vendor\Mpdf\WatermarkImage) {
