        ...
        foreach ( $items as $item ) {
            ...
            if ( ! empty( $item['price_breakdown'] ) && is_array( $item['price_breakdown'] ) && function_exists( 'wc_price' ) ) {
                ...
                if ( isset( $pb['subtotal'] ) ) {
                    $html .= '<tr><td style="color:#666">Zwischensumme (pro Stück)</td><td>' . wp_kses_post( wc_price( $pb['subtotal'] ) ) . '</td></tr>';
                }
                if ( isset( $pb['quantity'] ) ) {
                    $html .= '<tr><td style="color:#666">Menge</td><td>' . esc_html( $pb['quantity'] ) . ' Stück</td></tr>';
                }
                ...
                if ( ! empty( $pb['tax_rate'] ) ) {
                    $html .= '<tr><td style="color:#666">MwSt. (' . esc_html( $pb['tax_rate'] ) . '%)</td><td>' . wp_kses_post( wc_price( $pb['tax_amount'] ?? 0 ) ) . '</td></tr>';
                }
                if ( isset( $pb['total'] ) ) {
                    $html .= '<tr><td style="border-top:2px solid #ccc"><strong>Gesamt</strong></td><td style="border-top:2px solid #ccc"><strong>' . wp_kses_post( wc_price( $pb['total'] ) ) . '</strong></td></tr>';
                }
                $html .= '</table>';
            }
